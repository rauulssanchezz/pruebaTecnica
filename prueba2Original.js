function getTotal(transactionJson, category) {
  ...
  //console.log(list) otro console log que se me olvido borrar
  if(category){ //si category tiene un valor
    ...
    let bigger = 0 //creo una variable que guardara el mayor amount acumulado
    ...
    bigger = Math.max(...Object.values(obj)) //obtengo el mayor amount acumulado
    amount = bigger //asigno el mayor amount acumulado a la variable amount
  }
